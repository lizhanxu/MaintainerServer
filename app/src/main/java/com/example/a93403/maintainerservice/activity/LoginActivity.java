...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void loginClickListener() {
        ...
        HttpUtil.sendHttpRequest(UrlConsts.getRequestURL(Actions.ACTION_REQUEST_LOGIN), params, new HttpUtil.HttpCallbackListener() {
            @Override
...
//                    Map<String, String> map = JsonParser.parseLogin(response);
                    if (null != result) {
                        if (UrlConsts.CODE_SUCCESS.equals(result.getCode())) {
                            ...
                            tags.add(APPConsts.REPAIRMAN_TAG);
